...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/tables/{id}/fields/permissions": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/tables/{id}/fields/permissions/batch": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "swagger.BulkCreateTableDef": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/swagger.BulkCreateFieldDef"
                    }
                },
                "name": {
                    "type": "string",
        ...
        "swagger.DatabaseBulkCreateRequest": {
            ...
            "properties": {
                ...
                "tables": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/swagger.BulkCreateTableDef"
                    }
                }
            }
        },
        ...
        "swagger.FieldCreateRequest": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/swagger.FieldConfigSwagger"
                },
                "description": {
                    "type": "string",
        ...
        "swagger.FileObject": {
            ...
            "properties": {
                ...
                "storage_url": {
                    "type": "string",
                    "example": "/uploads/2026/05/report.pdf"
                }
            }
        },
